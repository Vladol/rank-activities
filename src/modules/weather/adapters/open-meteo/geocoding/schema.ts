...
import type { PlaceCandidate } from '../../../ports/place-lookup.port';

/**
 * The geocoding host's response, and the only place its field names appear.
 *
 * Choosing among candidates, deciding what counts as not found and giving a
 * place a stable identity are not this file's concern — they belong to
 * `location-applicability` (design.md, Decision 8 of
 * `01-add-weather-source-contract`). What happens here is translation and
 * nothing else.
 */
